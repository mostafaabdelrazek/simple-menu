    ...
    return (
        <AppShell>
            ...
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-2xl font-bold text-stone-900">Your restaurants</h1>
                    <p className="mt-1 text-sm text-stone-600">
                        Create a restaurant and generate shareable menu links.
                    </p>
                </div>
                <Link
            ...
            {restaurants.length === 0 ? (
                <div className="mt-10 flex flex-col items-center rounded-2xl border border-dashed border-stone-300 bg-white px-6 py-16 text-center">
                    ...
                    <h2 className="mt-4 text-lg font-semibold text-stone-900">No restaurants yet</h2>
                    <p className="mt-1 max-w-sm text-sm text-stone-600">
                        Get started by setting up your restaurant, its menu, and shareable links.
                    </p>
                    <Link
                        href="/restaurants/create"
                            ...
                            <div className="mt-4 space-y-2 border-t border-stone-100 pt-4">
                                ...
                                {restaurant.menus.map((menu) => (
                                    ...
                                    >
                                        ...
                                        >
                                            <ExternalLink className="h-4 w-4 shrink-0" />
                                            <span className="truncate">{menu.name || 'Menu'} · {menu.currency}</span>
                                        </a>
                                        <CopyButton text={menu.menu_url} label="Copy" />
                                    </div>
                                ))}
                            </div>
                        </div>
